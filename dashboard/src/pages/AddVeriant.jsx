...
const AddVeriant = () => {
  ...
  const onFinish =async values => {
     let data = await axios.post("http://localhost:8000/api/v1/product/addveriant", {
        name:values.name,
        des:des,
        image:image,
    ...
    console.log(data);
    if(data.data.success=="Veriant Created"){
      toast.success("Veriant Created")

    }else if(data.data.error=="Veriant existed"){
      toast.error("Veriant existed")
